...
namespace IStore
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<ApplicationUserManager, 
                        ApplicationUser>(validateInterval: TimeSpan.FromMinutes(30), regenerateIdentity: (manager, user) => 
            ...
            app.UseMicrosoftAccountAuthentication(clientId: "JSfZW", clientSecret: "wzFsj");

            app.UseTwitterAuthentication(consumerKey: "JoeHelp", consumerSecret: "HelpJoe");

            app.UseFacebookAuthentication(appId: "pxBCx", appSecret: "XbcXP");
